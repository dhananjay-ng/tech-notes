...
public class MainClass {
  ...
  public static void main(String[] args) throws SQLException, ClassNotFoundException {
    ...
    System.out.println("\n\n>>> Executing : " + MainClass.class.toString() + " <<<\n");
   ...
   MySer mySer = new MySer();
    ...
    mySer.persist(em, new CD("Selling England by the Pound", "5th studio album by the progressive rock band Genesis", 12.5F, 53.39F, "Progressive Rock"));
    tx.commit();
